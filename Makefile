...
ProgramSlicing: flex_c.l bison_c.y main.o ast_node.o cfg_node.o graph_to_dot.o write_ast_to_file.o
	bison -d bison_c.y
	flex flex_c.l
	$(CC) -o $@ bison_c.tab.c lex.yy.c main.o ast_node.o cfg_node.o graph_to_dot.o write_ast_to_file.o -lfl
